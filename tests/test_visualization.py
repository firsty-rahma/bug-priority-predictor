...
class TestEvaluationVisualizer:
    ...
    def test_plot_confusion_matrix(
        self, visualizer, sample_predictions, temp_directory
    ):
        ...
        fig = visualizer.plot_confusion_matrix(
            y_true, y_pred, title="Test Confusion Matrix", save_path=save_path
        )
    ...
    def test_plot_error_analysis(
        self, visualizer, sample_error_data, sample_confusion_patterns, temp_directory
    ):
        """Test error analysis plotting."""
        save_path = temp_directory / "error_analysis.png"

        fig = visualizer.plot_error_analysis(
            sample_error_data, sample_confusion_patterns, save_path=save_path
        )
    ...
    def test_plot_feature_importance(self, visualizer, temp_directory):
        ...
        fig = visualizer.plot_feature_importance(
            feature_names, importances, top_n=5, save_path=save_path
        )
